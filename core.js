  ...
  function createRoom() {
    return {
      ...
      furniture: [
        ...
        // 観葉植物。1 つの箱だと「緑のタンス」に見える。
        // 鉢 → 広がった葉 → 細くなる先端、と積んで輪郭を作る。
        { name: '植木鉢',     min: { x: 2.16, y: 0, z: 0.33 }, max: { x: 2.40, y: 0.26, z: 0.63 }, color: '#7a5540' },
        { name: '観葉植物',   min: { x: 2.04, y: 0.26, z: 0.22 }, max: { x: 2.51, y: 0.66, z: 0.74 }, color: '#375c42' },
        { name: '観葉植物',   min: { x: 2.14, y: 0.66, z: 0.33 }, max: { x: 2.42, y: 0.98, z: 0.64 }, color: '#416b4c' }
      ]
    };
  }
